...
Flie help_settings.yml should be generated in your /config folder. 

Open it and provide all page urls where help informations should be displayed. 
Next to each url provide name of a partial which you want to display in this page.
...
Now you should have new app/views/helps folder in which help templates are generated. 
...
Once user closes help it won't be displayed for him anymore.
   
In order to display template go to the page and add show_help(object) in the place
...
in User model and in each page where help template should be displayed add
